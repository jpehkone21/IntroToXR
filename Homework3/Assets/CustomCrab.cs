    ...
    void Update()
    {
        ...
        if (grabbing)
        {
            ...
            {   if (grabbedObject.GetComponent<Rigidbody>() != null){
                    ...
                    Vector3 deltaPos = transform.position - currentPosition;
                    Quaternion deltaRot = transform.rotation * Quaternion.Inverse(currentRotation);
                    grabbedObject.position = grabbedObject.position + deltaPos;
